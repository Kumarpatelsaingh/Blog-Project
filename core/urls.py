...
urlpatterns = [
    ...
    path("post/update/<uuid:pk>/", PostUpdateAPIView.as_view(),
         name="postupdate"),
    path("post/delete/<uuid:pk>/", PostDeleteAPIView.as_view(),
         name="postdelete"),
    path(
        "comments/post/<uuid:pk>/", PostCommentsListAPIView.as_view(),
        name="postdata"
    ),
    path("comments/user/<int:pk>/", CommentListAPIView.as_view(),
         name="commentuser"),
    path("comment/create/", CommentCreateAPIView.as_view(),
         name="commentcreate"),
    path("comment/delete/<uuid:pk>/", CommentDeleteAPIView.as_view(),
         name="commentdelete"),
    path("comment/update/<uuid:pk>/", CommentUpdateAPIView.as_view(),
         name="commentupdate"),
    ...
    path("follower/create/<int:pk>/", FollowersCreateAPIView.as_view(),
         name="followercreate"),
    ...
    path('students/name/', StudentByNameAPIView.as_view(),
         name='student-by-name'),
    path('students/email/', StudentByEmailAPIView.as_view(),
         name='student-by-name'),
    path('students/teacher/', StudentLearnByTeacherAPIView.as_view(),
         name='student-by-teacher'),
    path('students/exclude/', StudentsExcludingSAPIView.as_view(),
         name='student-by-name'),
    path('students/total/', TotalStudentsAPIView.as_view(),
         name='student-total'),
    path('students/subject/', StudentEnrolledSubjectAPIView.as_view(),
         name='student-sub'),
