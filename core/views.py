...
#             return Response(
#                 {"error": "name_start parameter is required"},
#                 status=status.HTTP_400_BAD_REQUEST,
#             )
...
#         letter_exclude = Student.objects.exclude(
#             id__in=Student.objects.filter(name__startswith=input_name).values_list(
#                 "id", flat=True
#             )
#         )
...
#             return Response(
#                 {"error": "enrolled_sub is required"},
#                 status=status.HTTP_400_BAD_REQUEST,
#             )
...
#             students_name_So
#             | students_name_not_S
#             | students_email_exact
#             | students_teacher_neha
#             | students_enrolled_python
#             | student_teacher_poja
#         )
