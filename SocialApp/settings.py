...
CELERY_ACCEPT_CONTENT = ["json"]  # Specify the content format
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = "hapatel@bestpeers.com"  # Replace with a real Gmail
EMAIL_HOST_PASSWORD = "admin@123"  # Use Gmail App Password, not your real password
